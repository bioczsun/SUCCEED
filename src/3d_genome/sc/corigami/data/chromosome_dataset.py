...
class ChromosomeDataset(Dataset):
    ...
    '''
    def __init__(self, celltype_root,cell_type, chr_name, omit_regions, feature_list, use_aug = True):
        ...
        self.mat = data_feature.HiCFeature(path = f'{celltype_root}/../{cell_type}/hic_matrix/{chr_name}.npz')
